...
class RestaurantBookingServer {
        ...
        tools: [
          {
            ...
            description: 'Search for restaurants based on location, cuisine types, mood, and event type. Returns top 3 AI-recommended restaurants within 20km radius. You can also search for specific food types using keywords.',
            inputSchema: {
              type: 'object',
              properties: {
                latitude: {
                  type: 'number',
                  description: 'Latitude of the search location (default: 24.1501164 - Taiwan)',
                  default: 24.1501164,
                },
                longitude: {
                  type: 'number',
                  description: 'Longitude of the search location (default: 120.6692299 - Taiwan)',
                  default: 120.6692299,
                },
                placeName: {
                  type: 'string',
                  description: 'Place name to search near (e.g., "New York", "Tokyo", "London"). Alternative to providing latitude/longitude coordinates.',
                },
                cuisineTypes: {
                  type: 'array',
                  items: { type: 'string' },
                  description: 'Array of preferred cuisine types (e.g., ["Italian", "Japanese", "Mexican"])',
                },
                keyword: {
                  type: 'string',
                  description: 'Search for specific food types or dishes (e.g., "hotpot", "sushi", "pizza", "ramen", "dim sum", "barbecue")',
                },
                mood: {
                  type: 'string',
                  description: 'Desired mood/atmosphere (e.g., "romantic", "casual", "upscale", "fun", "quiet")',
                },
                event: {
                  type: 'string',
                  enum: ['dating', 'family gathering', 'business meeting', 'casual dining', 'celebration'],
                  description: 'Type of event or occasion',
                },
                radius: {
                  type: 'number',
                  description: 'Search radius in meters (default: 20000 = 20km)',
                  default: 20000,
                },
                priceLevel: {
                  type: 'number',
                  enum: [1, 2, 3, 4],
                  description: 'Price level preference (1=inexpensive, 4=very expensive)',
                },
              },
              required: ['mood', 'event'],
            },
          },
          {
            ...
            description: 'Get detailed information about a specific restaurant including reviews, photos, and opening hours',
            inputSchema: {
              type: 'object',
              properties: {
                placeId: {
          ...
          },
          {
            ...
            description: 'Get instructions on how to make a reservation at a specific restaurant',
            inputSchema: {
              type: 'object',
              properties: {
                placeId: {
          ...
          },
          {
            ...
            description: 'Check availability for a restaurant reservation (mock implementation)',
            inputSchema: {
              type: 'object',
              properties: {
                placeId: {
          ...
          },
          {
            ...
            description: 'Attempt to make a restaurant reservation (mock implementation)',
            inputSchema: {
              type: 'object',
              properties: {
                placeId: {
              ...
              required: ['placeId', 'partySize', 'preferredDateTime', 'contactName', 'contactPhone'],
            },
          },
        ] as Tool[],
      };
  ...
  private async handleSearchRestaurants(args: any) {
    ...
    const restaurants = await this.googleMapsService.searchRestaurants(searchParams);
    ...
    const recommendations = await this.recommendationService.getRecommendations(restaurants, searchParams);
  ...
  private async handleGetRestaurantDetails(args: any) {
    const restaurant = await this.googleMapsService.getRestaurantDetails(args.placeId);
